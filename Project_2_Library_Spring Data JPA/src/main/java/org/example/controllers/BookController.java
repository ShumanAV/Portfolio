...
public class BookController {
    ...
    @PostMapping("/search")
    public String search(@RequestParam(value = "title", required = false) String startingWith, Model model) {
        model.addAttribute("startingWith", startingWith);
        model.addAttribute("books", bookService.findByTitleStartingWith(startingWith));
        return "/book/search";
    }
