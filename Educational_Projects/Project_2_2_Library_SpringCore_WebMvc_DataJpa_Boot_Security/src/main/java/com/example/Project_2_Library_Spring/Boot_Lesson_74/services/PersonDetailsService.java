...
/*
 Этот сервис будет специальным, т.к. он предназначается для Spring Security, чтобы spring security это знал,
 что этот сервис загружает пользователя, здесь мы должны реализовать интерфейс UserDetailsService
 */
@Service
...
public class PersonDetailsService implements UserDetailsService {
    ...
    /*
    Метод ищет пользователя по логину и возвращает его в обектрке PersonDetails
     */
    @Override
